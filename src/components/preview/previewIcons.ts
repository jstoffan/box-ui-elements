...
import IconFileDocument from '../../icon/content/FileWord32';
...
register(IconFileDocument, '#185ABD', ['doc', 'docx']);
...
register(IconFileGoogleSlides, '#F7BA00', ['gslide']);
...
register(IconFileText, vars.bdlBoxBlue, ['log', 'msg', 'ods', 'rtf', 'txt', 'wpd']);
