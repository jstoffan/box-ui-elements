...
import type { BoxItem, Token } from '../../common/types/core';
...
class PreviewSDK extends React.Component<Props> {
    ...
    loadPreview = () => {
        ...
        const { Preview: BoxPreview } = global.Box;
     ...
     */
    showPreview = () => {
        const { file, fileOptions, fileVersionId, id, showThumbnails, token, ...rest }: Props = this.props;
        ...
        TokenService.getReadToken(getTypedFileId(fileId), token).then(readToken => {
            ...
            this.preview.show(fileId, readToken, {
                ...rest,
                ...previewOptions,
            });
        });
